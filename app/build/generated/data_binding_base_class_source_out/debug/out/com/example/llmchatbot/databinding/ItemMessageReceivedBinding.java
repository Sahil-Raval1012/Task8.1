...
public final class ItemMessageReceivedBinding implements ViewBinding {
  ...
  private ItemMessageReceivedBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView ivBotAvatar, @NonNull TextView tvMessage, @NonNull TextView tvTimestamp) {
    this.rootView = rootView;
    this.ivBotAvatar = ivBotAvatar;
  ...
  public static ItemMessageReceivedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.ivBotAvatar;
      ImageView ivBotAvatar = ViewBindings.findChildViewById(rootView, id);
      if (ivBotAvatar == null) {
        break missingId;
      }
      ...
      return new ItemMessageReceivedBinding((ConstraintLayout) rootView, ivBotAvatar, tvMessage,
          tvTimestamp);
    }
